...
#====================================================================================================
df=pd.read_csv(r'C:\Users\Muthusamy\Documents\PROJECTS-2023\Final_project\N4\final_data.csv')
...
st.title(":violet[RETAIL SALES PREDICTION]")
...
with tab1:
    ...
    with col2:
        col2.image(Image.open(r"C:\Users\Muthusamy\Pictures\logo\images.png"), width=300)   
...
with tab2:
    ...
    if option == 'Prediction Process':
        ...
        with col10:
            ...
            import pickle
            model=pickle.load(open(r'C:\Users\Muthusamy\Documents\PROJECTS-2023\Final_project\N4\model.pkl', 'rb'))
    ...
    with tab3:
        ...
        with col8:
            ...
            st.subheader("As my observation from the analysis and prediction of this Data...") 
